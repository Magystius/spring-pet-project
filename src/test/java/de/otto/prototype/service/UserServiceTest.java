...
class UserServiceTest {
    ...
    void shouldAssertThatCountedAnnotationsAreInPlace() {
        stream(UserService.class.getDeclaredMethods())
    ...
    class getUsers {
        ...
        void shouldReturnEmptyListIfNoUserIsFound() {
        ...
        void shouldReturnListOfUsersFound() {
        ...
        void shouldReturnNoUserIfNotFound() {
    ...
    class deleteUser {
        ...
        void shouldThrowNotFoundExceptionForUnkownUserId() {
            given(userRepository.findById(VALID_USER_ID)).willReturn(Optional.empty());
